...
PATH=/usr/local/go/bin:$GOBIN:$GRADLE_HOME/bin:$HOME/.local/bin:$HOME/.config/emacs/bin:$HOME/.arkade/bin:$HOME/lib/flutter:$HOME/Android/Sdk/cmdline-tools/22.0/bin:$HOME/Android/Sdk/platform-tools:$PATH
